...
def run(apply_to_biosignalsplux_website=False, use_json_update_list=False):
    # ======================================================================================================================
    ...
    # ======================================================================================================================
    # ================================== Get the list of updated Notebooks =================================================
    # ======================================================================================================================
    list_updated_notebooks = []
    with open("../header_footer/biosignalsnotebooks_environment/last_updated_nbs.json") as json_file:
        list_updated_notebooks = json.load(json_file)["updated_notebooks"]
