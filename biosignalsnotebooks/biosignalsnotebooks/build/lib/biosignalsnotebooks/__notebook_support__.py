...
def plot_sample_rate_compare(data_dict):
    """
    -----
    Brief
    -----
    ...
    list_figures = plot([[]] * nbr_rows * 2, [[]] * nbr_rows * 2, y_axis_label="Raw Data",
                        ...
                        grid_plot=True, show_plot=False)
...
def plot_compare_act_config(signal, sample_rate):
    ...
    plot_list = plot([list([]), list([]), list([]), list([]), list([]), list([])],
                     ...
                     grid_lines=3, grid_columns=2, grid_plot=True, show_plot=False)
