...
run(list_notebooks=["plot_acquired_data_single"], exclude_notebooks=["hands_on_biostec", "hands_on_biostec_solutions", "quick_start_guide"],
    signal_samples_flag=False, delete_old_files=False, new_notebooks_list=["unit_conversion_RIP", "poincare_plot", "tachogram", "plot_acquired_data_single"])
