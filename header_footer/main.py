...
# Execute Script.
run(list_notebooks=["activity_distinction", "android_bitalino_sync", "android_file_sync"],
    exclude_notebooks=["hands_on_biostec", "hands_on_biostec_solutions"],
    signal_samples_flag=False, delete_old_files=False, delete_base_files=False,
    new_notebooks_list=["activity_distinction"])
