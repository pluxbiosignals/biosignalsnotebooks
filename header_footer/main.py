...
run(list_notebooks=["unit_conversion_gon"], exclude_notebooks=["hands_on_biostec", "hands_on_biostec_solutions", "quick_start_guide"],
    signal_samples_flag=False, delete_old_files=False, new_notebooks_list=["unit_conversion_gon"])
