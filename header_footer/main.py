...
# Execute Script.
run(list_notebooks=["temporal_statistical_parameters"], exclude_notebooks=["hands_on_biostec", "hands_on_biostec_solutions"],
    signal_samples_flag=False, delete_old_files=False, delete_base_files=True,
    new_notebooks_list=["digital_filtering_filtfilt", "temporal_statistical_parameters"])
