...
# Execute Script.
run(list_notebooks=["time_of_flight"], exclude_notebooks=["hands_on_biostec", "hands_on_biostec_solutions"],
    signal_samples_flag=False, delete_old_files=True, new_notebooks_list=["center_of_pressure", "time_of_flight"])
